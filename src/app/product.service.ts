...
export class ProductService {
  ...
  public viewProductByCategory(categoryName:any,productId:any){
    let viewProductByCategoryApi = "https://real-bidhouse.herokuapp.com/product/product-list-category"
    return this.http.post<any>(viewProductByCategoryApi,{categoryName: categoryName, productId:productId});
  }
}
